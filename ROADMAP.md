...
**Source of truth for behaviour:** [`specifications/`](specifications/README.md) · **Version:** 1.19.0 · 2026-09-18
...
`auth.*` and `sys.*` fixtures green with none pending, **236 fixtures on disk** (230 at `0.11.0`; M8a's six per-alternative recognition fixtures take it to 236 — R-23, D-M8-3).
