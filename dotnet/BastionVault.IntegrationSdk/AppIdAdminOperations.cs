...
public sealed class AppIdAdminOperations
{
    ...
    /// <summary>AUT-043: <c>LIST auth/{mount}/role</c>. An empty list when there are none (TRN-050).</summary>
    ...
    /// <summary>AUT-043: <c>GET auth/{mount}/role/{roleName}</c>.</summary>
    ...
    /// <summary>AUT-043: <c>POST auth/{mount}/role/{roleName}</c>.</summary>
    ...
    /// <summary>AUT-043: <c>DELETE auth/{mount}/role/{roleName}</c>.</summary>
    ...
    /// <summary>
    /// AUT-043: <c>POST auth/{mount}/role/{roleName}/role-id</c> — the write half of
    /// <see cref="AppIdOperations.ReadRoleIdAsync"/>.
    /// </summary>
    ...
    /// <summary>AUT-043: <c>GET auth/{mount}/role/{roleName}/{field}</c>.</summary>
    ...
    /// <summary>AUT-043: <c>POST auth/{mount}/role/{roleName}/{field}</c>.</summary>
    ...
    /// <summary>AUT-043: <c>POST auth/{mount}/role/{roleName}/secret-id/lookup</c>.</summary>
    ...
    /// <summary>AUT-043: <c>POST auth/{mount}/role/{roleName}/secret-id/destroy</c>.</summary>
    ...
    /// <summary>AUT-043: <c>POST auth/{mount}/role/{roleName}/secret-id-accessor/lookup</c>.</summary>
    ...
    /// <summary>AUT-043: <c>POST auth/{mount}/role/{roleName}/secret-id-accessor/destroy</c>.</summary>
    ...
    /// <summary>
    /// AUT-043: <c>POST auth/{mount}/role/{roleName}/custom-secret-id</c> — registers a
    /// caller-chosen secret id instead of generating one.
    /// </summary>
    ...
    /// <summary>AUT-043: <c>LIST auth/{mount}/role/{roleName}/machine/</c>.</summary>
    ...
    /// <summary>AUT-043: <c>DELETE auth/{mount}/role/{roleName}/machine/{machineId}</c>.</summary>
    ...
    /// <summary>
    /// AUT-043: <c>GET auth/{mount}/config</c>, which carries <c>require_machine</c> — the
    /// mount-wide half of AUT-040's machine-identity gate, default <b>on</b>.
    /// </summary>
    ...
    /// <summary>AUT-043: <c>POST auth/{mount}/config</c>.</summary>
